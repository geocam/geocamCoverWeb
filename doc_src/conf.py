...
version = geocamCover.get_version()
# The full version, including alpha/beta/rc tags.
release = geocamCover.get_version()
...
htmlhelp_basename = 'geocamCoverWebdoc'
...
latex_documents = [
  ('index', 'app.tex', u'geocamCoverWeb Documentation',
   u'Trey Smith', 'manual'),
]
